...
function PedukuhanCard({ pedukuhan, index, isInView }) {
  ...
  return (
    ...
    >
      {/* Card Image Area */}
      <div className={`relative h-44 overflow-hidden ${!showImage ? `bg-gradient-to-br ${pedukuhan.warna}` : ''}`}>
        {showImage ? (
          <>
            <img
              src={heroFoto}
