            ...
            {umkm.map((item, index) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {item.wa ? (
                    <a
                      href={`https://wa.me/${item.wa.replace(/[^0-9]/g, '')}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl bg-leaf-600 text-white text-sm font-medium hover:bg-leaf-700 transition-colors duration-200 shadow-sm"
                    >
                    ...
                    <div className="flex items-center justify-center w-full py-2.5 rounded-xl bg-gray-100 text-gray-400 text-sm">
