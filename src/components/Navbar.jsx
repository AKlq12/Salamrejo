        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link
              ...
              title="Admin Panel"
              className={`p-2 rounded-lg transition-all duration-200 group/profile ${
                scrolled || !isHome
                  ? 'text-gray-400 hover:text-leaf-700 hover:bg-leaf-50'
                  : 'text-white/50 hover:text-white hover:bg-white/15'
              }`}
            >
              <svg className="w-5 h-5 transition-transform duration-200 group-hover/profile:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <div className="bg-white/95 backdrop-blur-md px-4 py-3 space-y-1">
          ...
          <Link
            to="/admin"
            id="mobile-nav-admin"
            className="block px-4 py-2.5 rounded-lg text-sm font-medium text-gray-400 hover:text-leaf-700 hover:bg-leaf-50 transition-all flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
